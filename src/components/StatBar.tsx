...
export default function StatBar() {
  return (
    <section className="bg-xs-navy-light border-y border-xs-border">
      <div className="container-main py-8 lg:py-10">
        <div className="grid grid-cols-2 gap-6 md:grid-cols-4">
          {stats.map((s, i) => (
            <AnimateIn key={s.label} delay={i * 0.05}>
              <div className="text-center">
                <div className="font-heading text-2xl font-extrabold uppercase tracking-wider text-xs-green sm:text-3xl">
                  {s.value}
                </div>
