        ...
        <AnimateIn>
          <div className="text-center">
            ...
            <p className="mx-auto mt-3 max-w-lg text-xs-gray">
              We only work with local service businesses. That&apos;s it.
              No restaurants, no e-commerce, no SaaS startups. Just contractors.
            </p>
          </div>
        </AnimateIn>
        ...
        <div className="mt-12 grid grid-cols-2 gap-3 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6">
          {trades.map((t, i) => (
            <AnimateIn key={t.name} delay={i * 0.03}>
              <div className="flex flex-col items-center gap-2 rounded-lg border border-xs-border bg-xs-card/50 p-5 text-center transition-colors hover:border-xs-green/20 hover:bg-xs-card">
